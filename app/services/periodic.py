    ...
    async def _backup_loop(self) -> None:
        while True:
            ...
            try:
                ...
                await self.notifier.send(f"❌ LapBase: плановый backup не создан. Класс ошибки: {type(exc).__name__}")
    ...
    async def _cleanup_loop(self) -> None:
        while True:
            ...
            try:
                ...
                await self.notifier.send(f"❌ LapBase: плановая очистка не выполнена. Класс ошибки: {type(exc).__name__}")
