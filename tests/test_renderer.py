...
def config() -> Config:
    return Config(
        ...
        discord_api_timeout_seconds=30,
        discord_ready_timeout_seconds=30,
        sync_hours=24,
...
def test_image_urls_do_not_reduce_text_budget():
    without_images = text_budget("updates", [], config())
    with_images = text_budget(
        "updates",
        ["https://cdn.discordapp.com/a.jpg", "https://cdn.discordapp.com/b.jpg"],
        config(),
    )
